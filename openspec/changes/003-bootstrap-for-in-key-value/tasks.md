...
- [x] 1.1 Write a test program `for k, v in [10, 20, 30] { print(k) print(v) }`, compile it, dump bytecode, and verify ITER_NEXT operand has hasKey=1 flag set and two locals are allocated for k and v
