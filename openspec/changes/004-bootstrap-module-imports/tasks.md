...
- [x] 2.1 When interpreter encounters `import "./parser"`, resolve to `./parser.glyph` relative to current file directory, call readFile, parse source, execute in a new module scope, and bind exported `!` functions to the module namespace
