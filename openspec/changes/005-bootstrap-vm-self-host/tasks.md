...
- [x] 2.1 Ensure interpreter.glyph can `import "./lexer"` and `import "./parser"` via module resolution, then read and execute a simple test program (e.g., `print(2 + 3)`) producing output `5`
